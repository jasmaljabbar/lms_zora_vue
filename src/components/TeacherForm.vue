        ...
        <div
            ...
            <div class="flex items-center justify-between pb-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                <h3 class="text-lg font-medium text-gray-900">
                    {{ isEditing ? 'Edit Teacher Member' : 'Add Teacher Member' }}
                </h3>
            ...
            <form @submit.prevent="$emit('submit')" class="mt-6 space-y-6">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="first_name" v-model="teacher.first_name" type="text" required
                        ...
                        <div>
                            ...
                            <input id="last_name" v-model="teacher.last_name" type="text" required
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input id="date_of_birth" v-model="teacher.date_of_birth" required type="date"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="bio" v-model="teacher.bio" rows="3"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                                :class="{ 'border-red-500': errors.bio }"
                                placeholder="Brief description about the teacher member"></textarea>
              ...
              <input
                id="staff_id"
                v-model="teacher.staff_id"
                type="text"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                :class="{ 'border-red-500': errors.staff_id }"
                placeholder="e.g., STF001"
              >
              <p v-if="errors.staff_id" class="mt-1 text-sm text-red-600">{{ errors.staff_id[0] }}</p>
            </div> -->
                        ...
                        <div>
                            ...
                            <select id="department" v-model="teacher.department"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
              ...
              <p v-if="errors.employment_type" class="mt-1 text-sm text-red-600">{{ errors.employment_type[0] }}</p>
            </div> -->
              ...
              <p v-if="errors.hire_date" class="mt-1 text-sm text-red-600">{{ errors.hire_date[0] }}</p>
                        ...
                        <div>
                            ...
                            <input id="office_location" v-model="teacher.office_hours" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                                :class="{ 'border-red-500': errors.office_location }"
                                placeholder="e.g., Room 101, Admin Block">
                            <p v-if="errors.office_location" class="mt-1 text-sm text-red-600">{{
                                errors.office_location[0] }}</p>
                        </div>
              ...
              <input
                id="supervisor_id"
                v-model="teacher.supervisor_id"
                type="number"
                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                :class="{ 'border-red-500': errors.supervisor_id }"
                placeholder="Enter supervisor user ID"
              >
              <p v-if="errors.supervisor_id" class="mt-1 text-sm text-red-600">{{ errors.supervisor_id[0] }}</p>
            </div> -->
                    </div>
                </div>
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input id="phone_number" v-model="teacher.phone_number" type="tel"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input id="mobile_number" v-model="teacher.mobile_number" type="tel"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="address_line1" v-model="teacher.address_line1" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input id="address_line2" v-model="teacher.address_line2" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input id="city" v-model="teacher.city" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input id="state" v-model="teacher.state" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input id="country" v-model="teacher.country" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input id="postal_code" v-model="teacher.postal_code" type="text"
                                class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="flex items-center">
                        <input id="is_active_teacher" v-model="teacher.is_active_teacher" type="checkbox"
                            class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                        <label for="is_active_teacher" class="ml-2 block text-sm text-gray-700">
                            Active teacher Member
                        </label>
                    </div>
                    <p class="mt-1 text-sm text-gray-500">
                        Inactive teacher members won't be able to access the system
                    </p>
                </div>
