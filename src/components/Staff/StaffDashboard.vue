<!-- src/components/StaffDashboard.vue -->
<template>
  <div class="flex min-h-screen bg-gray-100">
    ...
    >
      ...
      <div class="flex items-center justify-between mb-6 lg:mb-10">
        <span class="text-xl sm:text-2xl font-bold text-gray-800">LMS Staff</span>
        <!-- Mobile Close Button -->
        <button
          @click="toggleMobileMenu"
        ...
        <ul class="space-y-1 sm:space-y-2">
          ...
          <li>
            <router-link 
              ...
              class="flex items-center p-2 sm:p-3 text-sm sm:text-base text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-colors duration-200"
            >
              <i class="pi pi-table mr-2 sm:mr-3 text-base sm:text-lg flex-shrink-0"></i>
              <span class="truncate">Class & Section</span>
            </router-link>
          </li>
          <li>
            <router-link 
          ...
          <li>
            <router-link 
              ...
              class="flex items-center p-2 sm:p-3 text-sm sm:text-base text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-colors duration-200"
            >
              <i class="pi pi-user-plus mr-2 sm:mr-3 text-base sm:text-lg flex-shrink-0"></i>
          ...
          <li>
            <router-link 
              ...
              class="flex items-center p-2 sm:p-3 text-sm sm:text-base text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-colors duration-200"
            >
              <i class="pi pi-building mr-2 sm:mr-3 text-base sm:text-lg flex-shrink-0"></i>
          ...
          <li>
            <router-link 
              ...
              class="flex items-center p-2 sm:p-3 text-sm sm:text-base text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-md transition-colors duration-200"
            >
              <i class="pi pi-user mr-2 sm:mr-3 text-base sm:text-lg flex-shrink-0"></i>
...
const fetchUser = async () => {
  ...
  try {
    ...
    const response = await api.get(`/staff_profiles/${userData.id}`);
