<!-- src/components/TeacherTimetable.vue -->
<template>
...
const fetchTimetable = async () => {
  ...
  try {
    ...
    // Then get timetable with both teacher_id and academic_session_id
    const response = await accapi.get(`/timetable/teacher/${teacherId}`, {
