...
<template>
  <div class="flex min-h-screen bg-gray-100">
    ...
    <!-- Sidebar -->
<aside
  class="fixed inset-y-0 left-0 w-64 bg-white shadow-md p-4 sm:p-6 flex flex-col"
>
  <!-- Logo -->
  <div class="flex items-center justify-between mb-6 lg:mb-10">
    <span class="text-xl sm:text-2xl font-bold text-gray-800">LMS Principal</span>
  </div>
